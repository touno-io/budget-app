<template>
  <div class="hidden md:flex md:w-64 md:flex-col md:fixed md:inset-y-0">
    <div class="flex-1 flex flex-col min-h-0 bg-gray-800">
      <div class="flex items-center gap-1 h-16 flex-shrink-0 px-4 bg-gray-900 text-white font-bold text-lg">
      ...
      <div class="flex-1 flex flex-col overflow-y-auto">
        <nav class="flex-1 px-2 py-4 space-y-1">
          ...
          <NuxtLink
            to="/"
            class="text-gray-300 hover:bg-gray-700 hover:text-white group flex items-center px-2 py-2 text-sm font-medium rounded-md"
            :class="$route.path == '/tables'? 'bg-gray-900' : ''"
          >
          ...
          <NuxtLink
            to="/"
            class="text-gray-300 hover:bg-gray-700 hover:text-white group flex items-center px-2 py-2 text-sm font-medium rounded-md"
            :class="$route.path == '/users'? 'bg-gray-900' : ''"
          >
          ...
          <NuxtLink
            to="/"
            class="text-gray-300 hover:bg-gray-700 hover:text-white group flex items-center px-2 py-2 text-sm font-medium rounded-md"
            :class="$route.path == '/waiting'? 'bg-gray-900' : ''"
          >
            <!-- Heroicon name: outline/chart-bar -->
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <NuxtLink
            to="/"
            class="text-gray-300 hover:bg-gray-700 hover:text-white group flex items-center px-2 py-2 text-sm font-medium rounded-md"
            :class="$route.path == '/order-history'? 'bg-gray-900' : ''"
          >
            <!-- Heroicon name: outline/chart-bar -->
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <NuxtLink
            to="/"
            class="text-gray-300 hover:bg-gray-700 hover:text-white group flex items-center px-2 py-2 text-sm font-medium rounded-md"
            :class="$route.path == '/texes'? 'bg-gray-900' : ''"
          >
            <!-- Heroicon name: outline/chart-bar -->
            <svg
              xmlns="http://www.w3.org/2000/svg"
